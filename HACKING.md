...
hidden if the `cmake-init-modules_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `cmake-init-modules_DEVELOPER_MODE` to the configure
