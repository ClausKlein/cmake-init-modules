if(PROJECT_IS_TOP_LEVEL)
  set(
      CMAKE_INSTALL_INCLUDEDIR "include/cmake-init-modules-${PROJECT_VERSION}"
      CACHE PATH ""
  )
endif()
...
install(
    ...
    LIBRARY #
    COMPONENT cmake-init-modules_Runtime
    NAMELINK_COMPONENT cmake-init-modules_Development
    ARCHIVE #
    COMPONENT cmake-init-modules_Development
    INCLUDES #
    DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}"
...
set(
    cmake-init-modules_INSTALL_CMAKEDIR "${CMAKE_INSTALL_LIBDIR}/cmake/${package}"
